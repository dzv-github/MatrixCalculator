...
determinant(target_matrix): calculate $det(target\_matrix)$ and return as int or float  
  
transpose(target_matrix): create transposed matrix and return as lists in list  
  
multiply(matrix_a,matrix_b): calculate $matrix\_a \\times matrix\_b$ and return as lists in list  
  
add(matrix_a,matrix_b): calculate $matrix\_a + matrix\_b$ and return as lists in list  
